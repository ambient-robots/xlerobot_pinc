...
from lerobot.robots.xlerobot_pro import XLerobotProTAHConfig, XLerobotProTAH
...
# Set to False to disable head teleop.
...
def main():
    ...
    robot_name = "ambient_xlerobot_pro_tah"
    try:
        robot_config = XLerobotProTAHConfig(id=robot_name, use_degrees=True)
        robot = XLerobotProTAH(robot_config)
        robot.connect()
