...
@ProcessorStepRegistry.register("gripper_velocity_to_joint_deg")
@dataclass
class GripperVelocityToJointDeg(RobotActionProcessorStep):
    """
    Converts a gripper velocity command into a target gripper joint position (in deg).
